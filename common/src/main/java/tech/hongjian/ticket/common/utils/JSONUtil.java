...
/**
 * Created by xiahongjian on 2021/6/23.
 */
@Slf4j
public class JSONUtil {
    ...
    public static <T> String toJSON(T obj) {
        try {
            ...
            log.warn("Failed to serialize the object to JSON.", e);
        }
        return "";
    }
    ...
    public static <T> T toBean(String json, Class<T> clazz) {
        try {
            ...
            log.warn("Failed to parse the JSON string to an object, JSON: {}", json, e);
        }
        return null;
    }
    ...
    public static <T> List<T> toList(String json, Class<T> clazz) {
        ...
        try {
            ...
            log.warn("Failed to parse the JSON string to a List object, JSON: {}", json, e);
        }
        return null;
    }
    ...
    public static <T> Map<String, T> toMap(String json, Class<T> clazz) {
        ...
        try {
            ...
            log.warn("Failed to parse the JSON string to a Map object, JSON: {}", json, e);
        }
        return null;
    }
